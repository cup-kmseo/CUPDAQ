...
public:
  ...
  void WriteADCSETUP(uint32_t addr, uint32_t data) const;
  ...
  void WriteADCBITSLIP(uint32_t ch, uint32_t data) const;
...
inline int NKFADC125S::Sid() const { return _sid; }